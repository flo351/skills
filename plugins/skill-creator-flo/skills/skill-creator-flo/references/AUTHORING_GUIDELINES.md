...
- **Explicit style header** (language, brevity): `**Respond in English. Be concise.**`
...
| No "Respond in X" line | Skill may answer in the wrong language | Add `**Respond in English. Be concise.**` |
